...
import { Home, User, Code, Briefcase, FolderKanban, GraduationCap, Trophy, Mail, Github, Linkedin } from "lucide-react"
...
const menuItems = [
  ...
  { href: "#hackathons", icon: Trophy, label: "Hackathons", color: "from-orange-500 to-red-600" },
